define(function () {
    ...
    var sounds = [
        {
            soundName: 'G2_PAD',
            soundSource: 'loops/new_loops/G2/1 - PAD.wav'
        },
        {
            soundName: 'G2_SYNTH',
            soundSource: 'loops/new_loops/G2/1 - SYNTH.wav'
        },
        {
            soundName: 'G2_SYNTH2',
            soundSource: 'loops/new_loops/G2/1 - SYNTH 2.wav'
        },
        {
            soundName: 'G2_VOIX1',
            soundSource: 'loops/new_loops/G2/1 - VOIX 1.wav'
        },
        {
            soundName: 'G2_VOIX3',
            soundSource: 'loops/new_loops/G2/1 - VOIX 3.wav'
        }
    ]
    ...
    var init = [
        ...
        'var synth2 = new Instrument("G2_SYNTH2")',
