define(function () {
    ...
    var portions = [
        {
            solution: [
                '// You can fix the rhythm here by lowering the value to 5.5 in i === 5.5 ',
            ...
            base: [
                '// Try to lower the value 9.5 in i === 9.5 and look at how this changes the sounds being played',
                'for (var i = 1.5; i < 17; i = i + 4)',
                '{',
                '    pattern.addSound(snare, i)',
                '    if (i === 9.5){',
        ...
        {
            solution: [
                '// You can fix the rhythm here by lowering the value to 4.5 in i === 4.5 ',
